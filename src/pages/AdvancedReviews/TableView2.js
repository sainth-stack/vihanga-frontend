  ...
  return (
    <div className="mt-5 text-center">
      <table className="table">
        ...
        <tbody>
          {report.report.scoreSelf.length > 0 && report.report.groupScore.filter(item => item.averageScore >= 2).length > 0 ? report.report.scoreSelf.sort((a, b) => a.averageScore < b.averageScore ? 1 : -1).map((item, index) => (
            <tr className='row1'>
