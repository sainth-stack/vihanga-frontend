      ...
      <div className="bg-white h-100 mt-5 mb-5">
        ...
        <div>
          ...
          <div className="pt-4 pb-4">
            <h5>Key Takeaways </h5>
            Based on the overall average of your results of the <span style={{ fontWeight: 'bold' }}>{selfReport.category}</span> competency breakdown, your capability to <span style={{ fontWeight: 'bold' }}>{selfReport.definitions.sort((a, b) => a.averageScore < b.averageScore ? 1 : -1)[0].defination}</span>  has been <span className="font-weight-bold">{averageScore <= 1 ? "Highly Unsatisfactory" : (averageScore > 1 && averageScore <= 2 ? "Unsatisfactory" : (averageScore > 2 && averageScore <= 3 ? "Satisfactory" : "Highly Satisfactory"))}</span> for the effectiveness of your team and for Vihanga. <br /><br />
            Your capability to <span className="font-weight-bold"> {selfReport.definitions.sort((a, b) => a.averageScore < b.averageScore ? -1 : 1)[0].defination}</span> has been <span className="font-weight-bold">{averageScoreLow <= 1 ? "Highly Unsatisfactory" : (averageScoreLow > 1 && averageScoreLow <= 2 ? "Unsatisfactory" : (averageScoreLow > 2 && averageScoreLow <= 3 ? "Satisfactory" : "Highly Satisfactory"))}</span> for the effectiveness of your team and for Vihanga.
          </div>
        </div>
      </div>
