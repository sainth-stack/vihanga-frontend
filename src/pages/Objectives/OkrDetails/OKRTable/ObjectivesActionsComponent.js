    ...
    <div className="d-flex flex-wrap">
      <div className="dropdown actionDropdown">
        ...
        >
          ...
          {
            //(row.objectiveStatus === "Unlock" || row.objectiveStatus === "Reject" || row.objectiveStatus === "Create" || row.objectiveStatus === "Update") && privileges && privileges.length > 0 && privileges.filter(privilege => privilege.page === "Objectives").length > 0 && privileges.filter(privilege => privilege.page === "Objectives")[0].delete &&
            <button
              className="btn btn-default dropdown-item text-capitalize text-left justify-content-start"
