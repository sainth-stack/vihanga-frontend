  ...
  return [
    {
      ...
      text: t("OKR Details.KEY RESULTS"),
      csvExport: false,
      style: { width: "20%" },
    ...
    },
    {
      ...
      text: t("OKR Details.TARGET DATE"),
      style: { width: "17%" },
    },
    {
      dataField: "target",
      text: t("OKR Details.TARGET"),
      style: { width: "8%" },
    },
    {
      dataField: "actual",
      text: t("OKR Details.ACTUAL"),
      style: { width: "8%" },
    },
    {
      dataField: "progress",
      text: t("OKR Details.PROGRESS"),
      style: { width: "25%" },
      formatter: (cellContent, row) => {
    ...
    },
    {
      ...
      formatter: (cellContent, row) => {
        return (
          <div className="d-flex flex-wrap">
            <div className="dropdown actionDropdown">
              <div onClick={() => handleOpenViewComments(row)}>
