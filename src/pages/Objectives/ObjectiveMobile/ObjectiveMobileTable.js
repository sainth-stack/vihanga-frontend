...
export default function ObjectiveMobileTable({ data = [], privileges, companyInfo, handleEdit, setEditModal, handleDelete, setOrderModalShow4, setMultipleObjectives, setSelectedObjective, refreshData, selectedUsers, setSelectedUsers }) {
