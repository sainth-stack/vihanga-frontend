...
export default function Reviews() {
  ...
  return (
    <>
      <div className="bg-light-primary rounded vh-100 p-4 non-printable">
        <div className="d-flex justify-content-between align-items-center">
          <h1>{t("ReviewsReport.ReviewsReport")}</h1>
          <div onClick={() => window.print()} className="cursor-pointer">
            <i className="fa fa-print h3" /> <span>{t("ReviewsReport.PrintReport")}</span>
          </div>
        </div>
