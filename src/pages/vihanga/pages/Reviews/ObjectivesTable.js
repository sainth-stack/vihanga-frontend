...
export default function ObjectivesTable(props) {
  ...
  // Add this useEffect to sync data with props.goals
  useEffect(() => {
    if (props.goals && Array.isArray(props.goals)) {
      setData(props.goals);
    }
  }, [props.goals]);
  ...
  return (
    <>
      ...
      <div className={isMobile ? "mt-4  pt-0 company-form-mobile" : "shadow mt-4 pt-0"} style={{marginTop: "2.5rem !important"}}>
