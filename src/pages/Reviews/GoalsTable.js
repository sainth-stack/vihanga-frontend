...
const devGif = require("assets/svg/dev-placeholder.svg");
  ...
  return (
    <>
      <div className={showGif ? "gif" : "dgif"}>
        <img src={isDev ? devGif : LottieConfettie} className={isMobile ? "mob-lottie-img col-12 h-50" : "lottie-img"} alt="LottieConfettie" />
        <br />
