...
import RecurrenceModal from "pages/Tasks/RecurrenceModal";
...
const SubTask = (props) => {
  ...
  const [task, setTask] = useState({
    status: "notstarted",
    mainTask: props.data.mainTask ? props.data.mainTask : "",
    userId: AuthUserId,
  });
  ...
  useEffect(() => {
    ...
    (function (m, a, z, e) {
      ...
      "5714035e-f24c-4a9a-ab13-c261f44181cb"
    );
        ...
        >
            ...
            <Row>
              <Col className={isMobile ? "" : "p-0"} lg={isMobile ? "10" : ""}>
                <TextInput
                  ...
                  // min={task.startDate ? window.moment(props.data.startDate).format("YYYY-MM-DD") : window.moment(new Date()).format("YYYY-MM-DD")}
                  // max={task.dueDate ? window.moment(props.dueDate).format("YYYY-MM-DD") : null}
                />
              </Col>
              {task2 === 2 && (
                <div
              ...
              >
                <TextInput
                  ...
                  min={
                    task.startDate
                      ? window.moment(task.startDate).format("YYYY-MM-DD")
                      : null
                  }
                  // max={task.dueDate ? window.moment(props.data.dueDate).format("YYYY-MM-DD") : null}
                />
              </Col>
              {task2 === 3 && (
                <div
          ...
          <div>
            <SelectInput
              ...
              name="mainTask"
              options={tasks}
              value={task.mainTask ? task.mainTask : props.data.mainTask}
              onChangeText={handleChange}
            />
          </div>
